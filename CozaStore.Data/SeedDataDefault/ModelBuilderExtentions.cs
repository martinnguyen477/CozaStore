    ...
    public static class ModelBuilderExtentions
    {
        public static void SeedDataDefault(this ModelBuilder modelbuilder)
        {
            ...
            modelbuilder.Entity<ProductEntities>().HasData(
                ...
                new ProductEntities { Id = 3, ProductName = "Áo thể thao trẻ em Adidas", CategoryId = 3, Price = 190000, Quantity = 150, ProductDescription = "Áo thời trang mùa đông", SupplierId = 1, Image = "/template/images/product-04.jpg", TagId = 1, Status = 1, CreateBy = 1, CreateDate = dateTime, UpdateBy = 1, UpdateDate = dateTime },
                new ProductEntities { Id = 4, ProductName = "Quần thể thao nam Adidas", CategoryId = 2, Price = 490000, Quantity = 150,  ProductDescription = "Áo thời trang mùa đông", SupplierId = 2, Image = "/template/images/product-05.jpg", TagId = 4, Status = 1, CreateBy = 1, CreateDate = dateTime, UpdateBy = 1, UpdateDate = dateTime },
                ...
                new ProductEntities { Id = 6, ProductName = "Quần thể thao trẻ em Adidas", CategoryId = 3, Price = 190000, Quantity = 150,  ProductDescription = "Áo thời trang mùa đông", SupplierId = 1, Image = "/template/images/product-06.jpg", TagId = 4, Status = 1, CreateBy = 1, CreateDate = dateTime, UpdateBy = 1, UpdateDate = dateTime },
                ...
                new ProductEntities { Id = 8, ProductName = "Guốc Juno", CategoryId = 1, Price = 510000, Quantity = 150,  ProductDescription = "Áo thời trang mùa đông", SupplierId = 2, Image = "/template/images/product-08.jpg", TagId = 1, Status = 1, CreateBy = 1, CreateDate = dateTime, UpdateBy = 1, UpdateDate = dateTime },
                new ProductEntities { Id = 9, ProductName = "Dép Bitis", CategoryId = 3, Price = 220000, Quantity = 150,  ProductDescription = "Áo thời trang mùa đông", SupplierId = 4, Image = "/template/images/product-09.jpg", TagId = 2, Status = 1, CreateBy = 1, CreateDate = dateTime, UpdateBy = 1, UpdateDate = dateTime },
                ...
                new ProductEntities { Id = 11, ProductName = "Tất nữ", CategoryId = 2, Price = 19000, Quantity = 150, ProductDescription = "Áo thời trang mùa đông", SupplierId = 1, Image = "/template/images/product-11.jpg", TagId = 2, Status = 1, CreateBy = 1, CreateDate = dateTime, UpdateBy = 1, UpdateDate = dateTime },
                new ProductEntities { Id = 12, ProductName = "Áo khoác trẻ em Nike", CategoryId = 3, Price = 690000, Quantity = 150,  ProductDescription = "Áo thời trang mùa đông", SupplierId = 1, Image = "/template/images/product-12.jpg", TagId = 2, Status = 1, CreateBy = 1, CreateDate = dateTime, UpdateBy = 1, UpdateDate = dateTime },
                new ProductEntities { Id = 13, ProductName = "Quần tay công sở", CategoryId = 2, Price = 850000, Quantity = 150,  ProductDescription = "Áo thời trang mùa đông", SupplierId = 3, Image = "/template/images/product-13.jpg", TagId = 3, Status = 1, CreateBy = 1, CreateDate = dateTime, UpdateBy = 1, UpdateDate = dateTime },
                new ProductEntities { Id = 14, ProductName = "Váy Elise", CategoryId = 1, Price = 1390000, Quantity = 150,  ProductDescription = "Áo thời trang mùa đông", SupplierId = 2, Image = "/template/images/product-14.jpg", TagId = 4, Status = 1, CreateBy = 1, CreateDate = dateTime, UpdateBy = 1, UpdateDate = dateTime },
            ...
            modelbuilder.Entity<TagEntities>().HasData(
